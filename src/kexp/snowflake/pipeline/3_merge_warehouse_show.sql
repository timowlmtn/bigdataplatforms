merge into WAREHOUSE.FACT_RADIO_SHOW dim
    ...
    when matched
        ...
        , dim.DIM_RADIO_STATION_KEY = str.DIM_RADIO_STATION_KEY
    ...
    when not matched
        then INSERT (DIM_RADIO_STATION_KEY, LOAD_ID, SHOW_ID, PROGRAM_ID, PROGRAM_NAME, PROGRAM_TAGS, HOST_NAMES, TAGLINE, START_TIME)
        values (str.DIM_RADIO_STATION_KEY, str.LOAD_ID, str.SHOW_ID, str.PROGRAM_ID, str.PROGRAM_NAME, str.PROGRAM_TAGS, str.HOST_NAMES,
